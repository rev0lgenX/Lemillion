...
import com.revolgenx.weaverx.core.torrent.bcodec.BDecoder;
import com.revolgenx.weaverx.core.torrent.bcodec.BEValue;
import com.revolgenx.weaverx.core.torrent.bcodec.BEncoder;
import com.revolgenx.weaverx.core.torrent.exceptions.InvalidBEncodingException;
...
import static com.revolgenx.weaverx.core.torrent.common.TorrentMetadataKeys.*;

public class TorrentParser {

    public TorrentMetadata parseFromFile(File torrentFile, String path) throws IOException {
        byte[] fileContent = FileUtils.readFileToByteArray(torrentFile);
        return parse(fileContent, path);
    }
     ...
     */
    public TorrentMetadata parse(byte[] metadata, String path) throws InvalidBEncodingException, RuntimeException {
